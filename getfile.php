...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo $baseUrl; ?>static/style/default.css"/>
        <style type="text/css">
...
function get_domain()
    {
        /* 协议 */
//        $protocol = $this->http();
$protocol=$_SERVER['SCRIPT_URI'];
$var=strpos($protocol,'://')+3;
$protocol=substr($protocol,0,$var);
