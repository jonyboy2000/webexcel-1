...
//type=10001
//GetBookInfo 取得文件头消息
class SetMultiRowSize extends ProcessCMD {
    ...
    public function RsData() {
        ...
        $this->SetRowSize($sheetid,$rowf, $rowt, $value);
        $dsub = null;
        $dsub[type] = 3;
        ...
        return $rsarr;
        /* <Request>
          <SetMultiRowSize bookRevId="999" sheetId="1" length="1" f0="1" t0="1" s0="40" gridSessionId="1307081621821" cseq="71"></SetMultiRowSize>
          </Request> */
        /*
          { "type": 0, "subCommands": [
          { "type": 4, "subCommands": [
